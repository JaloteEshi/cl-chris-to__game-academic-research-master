...
export default class Quiz extends React.Component {
  ...
  handleSubmit = event => {
    ...
    if (
      ...
      // console.log('1>>>', this.state.nParticipants !== game.treatment.playerCount.toString(), this.state.nParticipants, game.treatment.playerCount.toString());
      // console.log('2>>>', this.state.scoreOption !== "all", this.state.scoreOption);
      // console.log('3>>>', this.state.idle !== "-10");
      // console.log('4>>>', this.state.largeError !== "0");
      AlertToaster.show({
        message:
